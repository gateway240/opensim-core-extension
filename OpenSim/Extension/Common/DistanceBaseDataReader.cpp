...
namespace OpenSim {
    ...
    const std::string DistanceBaseDataReader::Orientations{ "orientations" };         // name of table for orientation data
    const std::string DistanceBaseDataReader::LinearAccelerations{ "linear_accelerations" };  // name of table for acceleration data
    const std::string DistanceBaseDataReader::MagneticHeading{ "magnetic_heading" };      // name of table for data from Magnetometer (Magnetic Heading)
    const std::string DistanceBaseDataReader::AngularVelocity{ "angular_velocity" };      // name of table for gyro data (AngularVelocity)
